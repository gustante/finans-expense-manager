...
/* harmony import */ var _ExpenseTable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExpenseTable */ "./src/ExpenseTable.js");
...
var current = new Date(); //get current date to set defaut date to today in the App states for quicker expense creation
...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      expenses: [],
      //contains the expenses from database
  ...
  _createClass(App, [{
    ...
    value: function handleExpenseSubmit(event) {
      var _this3 = this;
  ...
  _createClass(ExpenseTable, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevProps.expenses != this.props.expenses) {
        ...
        var _iterator = _createForOfIteratorHelper(this.props.expenses),
            _step;
...
var ModalSuccess = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ModalSuccess, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps, prevState) {
      //remounts the modal after updating message or showModalError state in App
    ...
    value: function render() {
      ...
      var showHideClassName = showModalError ? 'view' : 'hide'; ////whenever App updates with new message or showModalError becomes true/false, it controls the display of the modal by adding a classe that will show/hide
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Error"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "modal-body"
      }, this.props.errorMessages.map(function (message, index) {
...
var ModalSuccess = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ModalSuccess, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps, prevState) {
      //remounts the modal after updating message or showModalSuccess state in App
    ...
    value: function render() {
      ...
      var showHideClassName = showModalSuccess ? 'view' : 'hide'; //whenever App updates with new message or showModalError becomes true/false, it controls the display of the modal by adding a classe that will show/hide
      //bootstrap modal templates taken from https://getbootstrap.com/docs/4.0/components/modal/
...
/* harmony import */ var _style_sample_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style-sample.css */ "./src/style-sample.css");
/* harmony import */ var _style_sample_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_sample_css__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _App_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./App.js */ "./src/App.js");




react_dom__WEBPACK_IMPORTED_MODULE_1__.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_App_js__WEBPACK_IMPORTED_MODULE_3__.default, null), document.getElementById('react-container'));
