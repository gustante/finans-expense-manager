                    ...
                    <form id="expenseForm" onSubmit={this.props.handleExpenseSubmit}>
                        <div className="row">
                            ...
                            <div className="col-md-2 col-sm-3">
                                ...
                                <select aria-required="true" name="month" className="form-control" value={this.props.month} onChange={this.props.handleChange}>
                        ...
                        <div className="row justify-content-start">
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-6">
                                ...
                                <select id="typeSelector" name="type" className="form-control" value={this.props.type} onChange={this.props.handleChange}>
