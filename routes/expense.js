...
const {getAllExpenses, getExpense, getExpenseById, postExpense, deleteExpense, updateExpense} = require("../controllers/expenseController.js");
...
.put('/', updateExpense) ////updates expense
